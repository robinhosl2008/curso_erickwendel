...
const connection = require('../db/postgres/config/connection');
const schema = require('../db/postgres/schemas/heroiSchema');

const context = new Context(new Postgres(connection, schema));
const MOCK_HEROI = {
    nome: 'Robson',
    poder: 'Inteligência'
}
